...
#
# Boyd, Convex Optimization Figure 9.19 の追試
# 講義スライド p21 左図 も同じ
...
p = 2.5592666966582156   # tol = 1e-22 としたときの loss_arr[loss_arr.shape[0]-1]

iteration_axis = np.arange(0, loss_arr.shape[0])
fig, ax = plt.subplots(2, 2)

ax[0, 0].plot(iteration_axis, loss_arr, marker='x', color = 'b', label = 'objective funciton value')
